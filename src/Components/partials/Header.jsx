  ...
  useEffect(() => {
    if (allData.length > 0) {
      const interval = setInterval(() => {
        ...
        setWallpaper(randomData);
      }, 5000); // 8 seconds for better reading time
      return () => clearInterval(interval);
    }
  }, [allData]);

  // Title ko clean aur premium banane ka helper function
          ...
          >
            <div className="w-full h-full flex flex-col justify-end px-[5%] pb-20 z-10">
              ...
              <motion.div
                ...
                className="max-w-[800px]" // Isse text bohot zyada phailta nahi hai
              >
                {/* N Series Tag */}
                ...
                {/* TITLE - Fixed Size for Premium Look */}
                ...
                {/* INFO ROW (Rating & Year) - Adds Premium Detail */}
